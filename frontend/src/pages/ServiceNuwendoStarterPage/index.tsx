        ...
        <div className="container">
          <div className="max-w-6xl mx-auto space-y-14">
            <div className="text-center">
              <p className="text-brand font-semibold uppercase tracking-[0.2em]">Nuwendo Starter</p>
              <h1 className="mt-3 text-4xl md:text-6xl font-black uppercase italic text-brand-800 leading-[0.95]">
                Doctor-Led Weight Loss Starter Program
              </h1>
            ...
            <div className="relative">
              ...
              <h2 className="text-3xl md:text-4xl font-black uppercase italic text-brand-800 text-center">
                Patient Journeys with Nuwendo
              </h2>
              <p className="mt-4 text-center text-lg text-slate-600 max-w-3xl mx-auto">
                Real experiences from patients who trusted us. Every story is unique, every journey is guided by care.
              </p>
            ...
            <div className="text-center">
              <Link to="/signup" className="inline-flex items-center gap-2 text-2xl font-semibold text-brand hover:underline">
                Start your Nuwendo Starter journey now
